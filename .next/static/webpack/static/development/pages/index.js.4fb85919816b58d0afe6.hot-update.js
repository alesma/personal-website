...
function (_React$Component) {
  ...
  _createClass(Typewriter, [{
    ...
    value: function startTyping() {
      ...
      this.timeout = Object(timers__WEBPACK_IMPORTED_MODULE_1__["setTimeout"])(function () {
        this.setState({
          text: "".concat(this.state.text).concat(this.props.text.substring(this.textIndex, this.textIndex++))
        });
        console.log("".concat(this.state.text).concat(this.props.text.substring(this.textIndex, this.textIndex++)));
...
//# sourceMappingURL=index.js.4fb85919816b58d0afe6.hot-update.js.map