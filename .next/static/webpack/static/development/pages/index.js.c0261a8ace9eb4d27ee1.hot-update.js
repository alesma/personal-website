...
function (_React$Component) {
  ...
  _createClass(Typewriter, [{
    ...
    value: function startTyping() {
      ...
      if (this.props.text.lenght >= this.textIndex) {
        return;
      }

      this.timeout = Object(timers__WEBPACK_IMPORTED_MODULE_1__["setTimeout"])(function () {
        this.setState({
          text: "".concat(this.state.text).concat(this.props.text.substring(this.textIndex, 1))
        });
...
//# sourceMappingURL=index.js.c0261a8ace9eb4d27ee1.hot-update.js.map