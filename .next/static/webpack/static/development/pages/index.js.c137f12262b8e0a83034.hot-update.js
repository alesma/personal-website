  ...
  _createClass(Typewriter, [{
    ...
    value: function startTyping() {
      ...
      this.timeout = Object(timers__WEBPACK_IMPORTED_MODULE_1__["setTimeout"])(function () {
        _this2.setState({
          text: "".concat(_this2.state.text).concat(_this2.props.text.substring(_this2.textIndex, _this2.textIndex++))
        });

        _this2.textIndex = _this2.textIndex++;
...
//# sourceMappingURL=index.js.c137f12262b8e0a83034.hot-update.js.map